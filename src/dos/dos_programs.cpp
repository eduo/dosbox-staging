...
#if !C_BOXER
// SHOWPIC is the only thing in the tree that needs SDL_image. Boxer would have
// to bundle that library purely for a DOS picture viewer its users never run,
// so the program is left out of Boxer builds.
